        ...
        if(msg.contains("missing")){
            ...
            for(String a: keywords){
                if(tokens[1].contains(a)){
                    System.err.println("Line "+ line + ":" + charPositionInLine + " could not find a valid token for" + tokens[1] +". May have a typo or duplicate." );
                    flag = false;
                    break;
                }
            }
            ...
            if(tokens[1].contains("Identifier")){
                ...
                System.err.println("Line "+ line + ":" + charPositionInLine + tokens[0] + "did not match any token, try replacing with a comparison operator." );
            }
            else {
